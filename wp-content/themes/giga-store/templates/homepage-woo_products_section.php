		...
		<?php if ( class_exists( 'WooCommerce' ) ) : ?>
			<div class="woo-tabs-section row">
				<div class="col-sm-12">
					...
					if ( $query->have_posts() ) :
						echo do_shortcode( '[' . esc_attr( get_theme_mod( 'woo_products_settings', 'recent_products' ) ) . ' per_page="' . absint( get_theme_mod( 'products_per_page', '8' ) ) . '" columns="' . absint( get_theme_mod( 'products_per_row', '4' ) ) . '" orderby="date" order="ASC"]' ); 
					else : 
					?>
