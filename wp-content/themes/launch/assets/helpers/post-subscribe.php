<?php
    ...
    $mailchimp_enable_redirect = get_theme_mod('launch_mailchimp_enable_redirect');
    $mailchimp_redirect_url = get_theme_mod('launch_mailchimp_redirect_url');
/**
...
class MailChimp
{
    ...
    */
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( $result['status'] == 400 && !empty( $mailchimp_enable_redirect ) && !empty( $mailchimp_redirect_url ) ) {
            $response = array( 
                'status' => 'redirect',
                'url' => $mailchimp_redirect_url,
                );
